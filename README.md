...
- Assuming you already have python and pip (if not, check out [How to install](https://pip.pypa.io/en/stable/installing/)), install requirements using `​ pip install -r requirements.txt` within command prompt or terminal
